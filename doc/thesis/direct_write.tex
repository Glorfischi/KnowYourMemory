...
\comment{I just realized I never covered rkeys.. Is this necessary?}
...
With our Direct Write connection we essentially rebuilt the send and receive verss using only RDMA writes. This gives us more
