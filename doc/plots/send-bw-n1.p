...
do for [c in conns] {
  bw = sprintf("data/sendrcv-bw-param/sendRcv-bw-size-16-unack-64-batch-1-conn-%s-single-rcv-server", c )
...
set print $data512
do for [c in conns] {
  bw = sprintf("data/sendrcv-bw-param/sendRcv-bw-size-512-unack-64-batch-1-conn-%s-single-rcv-server", c )
  stats bw using 5 noout
  print sprintf("%s %f\n", c, STATS_sum*8/1024/1024/1024)
}
...
set print $data8192
do for [c in conns] {
  bw = sprintf("data/sendrcv-bw-param/sendRcv-bw-size-8192-unack-64-batch-1-conn-%s-single-rcv-server", c )
  stats bw using 5 noout
  print sprintf("%s %f\n", c, STATS_sum*8/1024/1024/1024)
}
